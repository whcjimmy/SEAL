...
__extension__ typedef unsigned __int128 uuint128_t;
#define SEAL_MULTIPLY_UINT64_HW64(operand1, operand2, hw64)                                 \
    do                                                                                      \
    {                                                                                       \
        *hw64 = static_cast<unsigned long long>(                                            \
            ((static_cast<uuint128_t>(operand1) * static_cast<uuint128_t>(operand2)) >> 64)); \
    } while (false)

#define SEAL_MULTIPLY_UINT64(operand1, operand2, result128)              \
    do                                                                   \
    {                                                                    \
        uuint128_t product = static_cast<uuint128_t>(operand1) * operand2; \
...
#define SEAL_DIVIDE_UINT128_UINT64(numerator, denominator, result)                                 \
    ...
    {                                                                                              \
        uuint128_t n, q;                                                                            \
        n = (static_cast<uuint128_t>(numerator[1]) << 64) | (static_cast<uuint128_t>(numerator[0])); \
        q = n / denominator;                                                                       \
        n -= q * denominator;                                                                      \
